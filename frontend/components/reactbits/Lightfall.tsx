...
// React Bits <Lightfall /> — WebGL "light rain" streak tunnel (ogl). TS port for
// Bullseye; render via next/dynamic({ ssr: false }) on desktop + no reduced-motion.
...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    if (mouseInteraction) {
      // Listen on window so the cursor light tracks even under pointer-events:none.
