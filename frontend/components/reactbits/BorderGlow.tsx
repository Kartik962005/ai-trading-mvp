...
// React Bits <BorderGlow /> — cursor-following mesh-gradient border + edge glow
// for cards. Ported to TS for Bullseye; CSS embedded so it is self-contained.
