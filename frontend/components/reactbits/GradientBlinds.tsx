...
// React Bits <GradientBlinds /> — WebGL gradient-blinds shader background (ogl).
// Ported to TS for Bullseye; render only on desktop + no reduced-motion, and
...
`;
    ...
    // Listen on window so the background reacts even under pointer-events:none.
