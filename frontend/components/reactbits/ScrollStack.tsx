...
// React Bits <ScrollStack /> — cards that pin and stack with scale as you
// scroll (lenis-powered). Ported to TS for Bullseye. CSS is embedded so the
